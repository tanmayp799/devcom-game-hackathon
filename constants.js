...
const BALL_INIT_POS = [
	...
	{x: 1090*D_CANVAS_W/1500 + 2 * D_BALL_RADIUS * Math.sqrt(3), y: D_CANVAS_H/2 + 2 * D_BALL_RADIUS},
	{x: 1090*D_CANVAS_W/1500 + D_BALL_RADIUS * Math.sqrt(3), y: D_CANVAS_H/2 - D_BALL_RADIUS},
	
	{x: 1090*D_CANVAS_W/1500 + 2 * D_BALL_RADIUS * Math.sqrt(3), y: D_CANVAS_H/2 - 2*D_BALL_RADIUS},
	{x: 1090*D_CANVAS_W/1500 + 2 * D_BALL_RADIUS * Math.sqrt(3), y: D_CANVAS_H/2 - 4 * D_BALL_RADIUS},
	{x: 1090*D_CANVAS_W/1500 + D_BALL_RADIUS * Math.sqrt(3), y: D_CANVAS_H/2 + 3*D_BALL_RADIUS},
	{x: 1090*D_CANVAS_W/1500 - D_BALL_RADIUS * Math.sqrt(3), y: D_CANVAS_H/2 + D_BALL_RADIUS},
	{x:1090*D_CANVAS_W/1500, y: D_CANVAS_H/2},
	{x: 1090*D_CANVAS_W/1500 - 2 * D_BALL_RADIUS * Math.sqrt(3), y: D_CANVAS_H/2},
	{x: 1090*D_CANVAS_W/1500 + D_BALL_RADIUS * Math.sqrt(3), y: D_CANVAS_H/2 + D_BALL_RADIUS},
	{x: 1090*D_CANVAS_W/1500 + 2 * D_BALL_RADIUS * Math.sqrt(3), y: D_CANVAS_H/2 + 4 * D_BALL_RADIUS},
	{x: 1090*D_CANVAS_W/1500 - D_BALL_RADIUS * Math.sqrt(3), y: D_CANVAS_H/2 - D_BALL_RADIUS},
	{x: 1090*D_CANVAS_W/1500 + 2 * D_BALL_RADIUS * Math.sqrt(3), y: D_CANVAS_H/2},
